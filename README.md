...
6. Fix bert nlp seg model bug for chinese text<br>
   ...
   Specifically, you can make changes to the cut_sentence function in modelscope.pipelines.nlp.document_segmentation_pipeline.<br>
   To address the problem, remove the decimal point from the first regular expression in the function. <br>This modification should help improve the handling of English periods during sentence segmentation in Chinese text.
