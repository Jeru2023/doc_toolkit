...
class Router:
    def __init__(self):
        self.paragraph_cutter = NaturalCutter()
        self.sentence_cutter = SentenceCutter()

    def stat(self, text):
        sentences = self.sentence_cutter.cut(text)
        paragraphs = self.paragraph_cutter.cut(text)

        text_len = len(text)
        sentences_count = len(sentences)
        paragraphs_count = len(paragraphs)

        avg_sentence_len = text_len / sentences_count
        avg_paragraph_len = text_len / paragraphs_count
        ...
        print("Paragraphs size:", paragraphs_count)
        ...
        # 2.1 if avg_paragraph_len < 150 remove '\n'
